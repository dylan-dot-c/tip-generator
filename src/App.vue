      ...
      <div class="space-y-4">
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-4 mt-4 md:grid-cols-3">
            ...
            <div>
              <input type="radio" name="tipVal" id="custom" :value="customValue" class="hidden" />
              <label for="custom">
                <span
                  ><input
                    ...
                    class="text-right text-very-dark-cyan text-xl p-3 w-full bg-very-light-cyan placeholder:text-very-dark-cyan placeholder:font-bold border border-transparent focus:border-strong-cyan outline-none rounded-md"
                /></span>
              </label>
            </div>
          </div>
